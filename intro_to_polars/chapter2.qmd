...
Polars offers various optional dependencies for specific use cases, which is done to reduce the footprint of the library. Throught this guide I will mention when specific dependancts are required/used.
